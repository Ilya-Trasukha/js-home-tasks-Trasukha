...
var radiusClock = 200; //радиус для циферблата
var radiusNamber = 160; //радиус цифр
var deg = 6; //поворот 6 градусов за секунду
var wrapper = document.getElementById('wrapper');
var clock = document.createElement('div');//контейнер для циферблата
var elemForArrowHours = document.createElement("div") // контейнер для стрелки часов
var elemForArrowMinutes = document.createElement("div") // контейнер для стрелки минут
var elemForArrowSeconds = document.createElement("div") // контейнер для стрелки секунд
var DigitalWatch = document.createElement("div");//контейнер для цифровых часов
