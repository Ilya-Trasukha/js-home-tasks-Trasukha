...
var numbersBaseRadius = baseRadius / 1.25; //радиус оси цифр циферблата
...
function createWatch() {
  ...
  base.setAttribute('fill', 'rgb(255, 99, 71)');
...
function createDigitalWatch() {
  ...
  DigitalWatch.setAttribute('y', 180);
  DigitalWatch.setAttribute('fill', 'rgb(240, 230, 140)');
...
function createClockFace() {
  ...
  for (let number = 1; number <= 12; number++) {
    ...
    text.setAttribute('fill', 'rgb(255, 20, 147)');
...
function createHourCircle(circleX, circleY) {
  ...
  circle.setAttribute('fill', 'rgb(0, 255, 255)');
...
function createDecorativeDot(size) {
  ...
  dot.setAttribute('fill', 'rgb(240, 230, 140)');
